...
> **Permit rule:** Cedar/Zen decide on **financial events**, not on an agent filing the report. Coding-agent evals in `evals/` are a separate path. Same instinct: [SafetyMP](https://github.com/SafetyMP/SafetyMP).
